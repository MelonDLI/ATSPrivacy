...
def create_save_dir():
    return '/home/remote/u7076589/ATSPrivacy/ResNet_result_epoch_psnr' #! change
...
def main():
    ...
    for i in [1,10,50,100,150,200]:
        file = '{}_epoch_{}_optim_inversed_mode_aug_auglist__rlabel_False/metric.npy'.format(set_attack_mode(),i)
