...
def create_save_dir():
    # return 'checkpoints/MoEx_bn_ResNet_20_lam_09_p_05_DA'
    return opt.save_dir
...
def main():
    ...
    loss_fn, trainloader, validloader = preprocess(opt, defs=defs)
    ...
    #! MoEx=True
    training_routine.train(model, loss_fn, trainloader, validloader, defs, setup=setup, save_dir=save_dir, MoEx=True)
...
#     path = './MoEx_bn_lambda_09_DA_plot'
