...
# python /home/remote/u7076589/ATSPrivacy/benchmark_copy/metric/basis.py --data=cifar100 --arch='ResNet20-4' --epochs=200 --aug_list='' --mode=aug --Mixup=True --lambda=0.3
...
parser.add_argument('--lambda',default=0.5, help='0.3-0.5')
# # defense
...
def data_root():
    return '/home/remote/u7076589/ATSPrivacy/benchmark_copy/mixup'
...
def create_checkpoint_dir():
    ...
    return '/home/remote/u7076589/ATSPrivacy/checkpoints/Mixup/Mixup_lambda_{}_data_cifar100_arch_ResNet20-4_mode_aug_auglist__rlabel_False'.format(opt.lambda)
def create_save_dir():
    return '/home/remote/u7076589/ATSPrivacy/benchmark_copy/metric/mixup/mixup_ssim_npy/'
...
def main():
    ...
    image_list_rec = ['{}_ori.jpg'.format(i+1) for i in range(100) ] # vanilla resnet
    ...
    np.save('{}/metric_ssim_ori_rec_{}.npy'.format(save_dir,opt.lambda),ssim_metric_list)
